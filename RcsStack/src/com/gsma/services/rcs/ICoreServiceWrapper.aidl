...
interface ICoreServiceWrapper {
    ...
    IBinder getUploadServiceBinder();
    IBinder getHistoryServiceBinder();
    IBinder getAospPresenceServiceBinder(int soltId);
    IBinder getAospOptionsServiceBinder(int soltId);
}
