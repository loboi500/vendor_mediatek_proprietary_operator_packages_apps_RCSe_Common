...
public class Configuration implements Parcelable {
    ...
    public static final long INITIAL_VERSION = 0x3754952700010001L;
    ...
    public Configuration(Configuration other) {
        ...
        security_verify = other.security_verify;
    ...
    public String toString() {
        ...
        builder.append(userAgent);
        builder.append("],");
        builder.append("port_s[");
        builder.append(portS);
        builder.append("],");
        builder.append("viaPort[");
        builder.append(viaPort);
        builder.append("],");
        builder.append("security_verify[");
        builder.append(security_verify);
        builder.append("],");
        builder.append("pAssociatedUri[");
        builder.append(pAssociatedUri);
        builder.append("],");
        builder.append("pIdentifier[");
        builder.append(pIdentifier);
        builder.append("],");
    ...
    public void setSecurityVerify(String security_verify) {
        this.security_verify = security_verify;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(portS);
        dest.writeInt(viaPort);
        dest.writeString(security_verify);
